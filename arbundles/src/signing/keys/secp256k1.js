...
class Secp256k1 {
    ...
    static async verify(pk, message, signature) {
        ...
        let verified = false;
        try {
            verified = secp256k1_1.default.ecdsaVerify(signature, (0, keccak256_1.default)(message), p);
    ...
    sign(message) {
        return secp256k1_1.default.ecdsaSign((0, keccak256_1.default)(message), Buffer.from(this.key))
            .signature;
    }
}
