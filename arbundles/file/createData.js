...
async function createData(data, signer, opts) {
    ...
    (0, assert_1.default)(_owner.byteLength == signer.ownerLength, new Error(`Owner must be ${signer.ownerLength} bytes`));
    stream.write(_owner);
    stream.write(_target ? singleItemBuffer(1) : singleItemBuffer(0));
    if (_target) {
        (0, assert_1.default)(_target.byteLength == 32, new Error("Target must be 32 bytes"));
