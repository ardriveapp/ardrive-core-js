...
import { DriveSyncState, EntitySyncState } from '../src/types/sync_types';
...
export const stubDriveSyncState = (): DriveSyncState => {
	...
	return {
		driveId: EID('11111111-1111-1111-1111-111111111111'),
		drivePrivacy: 'public',
