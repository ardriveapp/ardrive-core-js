...
import { ArFSLocalPublicFile } from './../types/client_Types';
...
export async function createArFSFileSharingLink(user: ArDriveUser, fileToShare: ArFSLocalPublicFile): Promise<string> {
	let fileSharingUrl = '';
	try {
