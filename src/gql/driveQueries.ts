...
import { CipherType, DrivePrivacy, drivePrivacyValues, entityTypeValues } from '../types/type_guards';
import { EntityQuery } from './EntityQuery';
import { NODE_ID_AND_TAGS_PARAMETERS, Query } from './Query';

const entityType = entityTypeValues.DRIVE;

export const getPrivateDriveEntity = getDriveEntity.bind(this, drivePrivacyValues.PRIVATE);

export const getPublicDriveEntity = getDriveEntity.bind(this, drivePrivacyValues.PUBLIC);

export const getAllPrivateDriveEntities = getAllDriveEntities.bind(this, drivePrivacyValues.PRIVATE);

export const getAllPublicDriveEntities = getAllDriveEntities.bind(this, drivePrivacyValues.PUBLIC);
...
export async function getSharedPublicDrive(driveId: string): Promise<ArFSDriveMetaData> {
	const query = new EntityQuery<ArFSDriveMetaData>({
		entityType,
		entityId: driveId,
		privacy: drivePrivacyValues.PUBLIC
	});
...
export const getAllMyPublicArDriveIds = getAllMyArDriveIds.bind(this, drivePrivacyValues.PUBLIC);

export const getAllMyPrivateArDriveIds = getAllMyArDriveIds.bind(this, drivePrivacyValues.PRIVATE);
