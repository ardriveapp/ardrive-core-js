...
const bundleName = "ardrive-core-js"
...
async function makeDefinitionsCode() {
  const defs = [
    "// -- Usage definitions --",
    removeLocalImportsExports((await readFile(path.join(distNpmPath, "exported-definitions.d.ts"), "utf-8")).trim()), // changed this from srcPath
